            ...
            navigator.mediaDevices.getUserMedia(
                ...
                .then((mediaStream) => {
                    ...
                    mediaRecorder.onstop = () => {
                        ...
                        // Create a upload button that lets the
                        // user upload the recorded media
                        const uploadButton = document.createElement("a");
                        uploadButton.innerText = "Upload it!";

                        uploadButton.onclick = () => {
                            let recordType = selectedMedia === "vid" ? "video" : "audio";
                            let recordExtension = selectedMedia === "vid" ? "mp4" : "mp3";

                            const recordFile = new File([blob], "untitled", {
                                type: blob.Type,
                            ...
                            formData.append('recordExtension', recordExtension);
                            formData.append('recordFile', recordFile);

                            $.ajax({
                                type: "POST",
                                url: "{{ route('web.upload') }}",
                                contentType: false,
                                processData: false,
                                data: formData,
                                beforeSend: function () {
                        ...
                        document.getElementById(
                            ...
                            recordedMedia, downloadButton, br, uploadButton);
                    };
